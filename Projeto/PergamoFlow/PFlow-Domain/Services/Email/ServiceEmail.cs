...
namespace PFlow_Domain.Services.Email
{
    public class ServiceEmail
    {
        ...
        public async Task<bool> EnviarEmailAsync(string destinatario, string assunto, string conteudoTexto, List<string> caminhosAnexos = null)
        {
            try
            {
                ...
                return await EnviarViaSmtpAsync(mensagem, credential);
            }
            catch (Exception ex)
            {
